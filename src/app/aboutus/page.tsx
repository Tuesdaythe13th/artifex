/**
 * v0 by Vercel.
 * @see https://v0.dev/t/FawTzQSEDhu
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl text-center">
          ...
          <p className="text-muted-foreground text-lg">
            At ARTIFEX, we are driven by a deep commitment to using technology, design, and creative thinking to drive
            positive social change. Our multidisciplinary team works at the forefront of innovation, exploring new
            frontiers in art, code, and responsible AI.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                Our team of researchers and scientists are at the forefront of emerging technologies, constantly
                exploring new frontiers to push the boundaries of what's possible.
              </p>
            </div>
            <div className="bg-background rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                We work closely with our clients to develop tailored strategies that leverage the power of technology,
                design, and creative thinking to achieve their goals.
              </p>
            </div>
            <div className="bg-background rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground">
                Driving positive social change is at the heart of everything we do. We're committed to using our
                expertise to create solutions that make a real difference in the world.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Interested in working with us? We're always looking for talented individuals who share our passion for
